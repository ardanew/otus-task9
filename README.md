# Использование
bin/demo_app - демонстрационная программа \
lib/libasync.so - библиотека с функциями \
tests/async_tests - тесты \

использовать без установки из пакета - зайти в каталог с приложением и запустить LD_LIBRARY_PATH=../lib ./demo_app

при работе создаёт логи, суффиксы файлов - _h1 (лог создан из первого инстанса) _t1 (пишется первым потоком)
